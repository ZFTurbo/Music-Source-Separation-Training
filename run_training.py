...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="/Users/kaimikkelsen/canada_compute/data/MUSDB18HQ/Faces On Film - Waiting For Ga", help="Path to training data")
