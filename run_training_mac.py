...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="/Users/kaimikkelsen/canada_compute/data/extracted_stems_test", help="Path to training data")
    parser.add_argument("--valid_path", type=str, default="../data/MUSDB18/validation", help="Path to validation data")
